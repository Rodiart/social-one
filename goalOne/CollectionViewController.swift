...
//        testArray.append("Say hi to someone new")
//        testArray.append("Eat something new")
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [NSFontAttributeName: UIFont(name: "HelveticaNeue-Thin", size: 35)!]
    ...
    */
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        cell.mainLabel.setValue(UIColor.whiteColor(), forKey: "textColor")
